...
import me.devnull.renegadeincai.di.appModule
import me.devnull.renegadeincai.di.dataSourceModule
import me.devnull.renegadeincai.di.repositoryModule
import me.devnull.renegadeincai.di.viewModelModule
import me.devnull.renegadeincai.data.files.FilesManager
import me.devnull.renegadeincai.data.datastore.SettingsStore
import me.devnull.renegadeincai.service.WebServerService
import me.devnull.renegadeincai.utils.CrashHandler
import me.devnull.renegadeincai.utils.DatabaseUtil
...
private const val TAG = "RenegadeHubApp"

const val CHAT_COMPLETED_NOTIFICATION_CHANNEL_ID = "chat_completed"
const val CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID = "chat_live_update"
const val WEB_SERVER_NOTIFICATION_CHANNEL_ID = "web_server"

class RenegadeIncAIApp : Application() {
    override fun onCreate() {
        super.onCreate()
        startKoin {
            androidLogger()
            androidContext(this@RenegadeIncAIApp)
            workManagerFactory()
        ...
        get<AppScope>().launch {
            runCatching {
                ...
                if (settings.webServerEnabled) {
                    ...
                    val intent = Intent(this@RenegadeIncAIApp, WebServerService::class.java).apply {
