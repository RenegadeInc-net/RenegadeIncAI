...
import me.devnull.renegadeincai.ui.components.richtext.HighlightCodeVisualTransformation
import me.devnull.renegadeincai.ui.components.ui.FormItem
import me.devnull.renegadeincai.ui.components.ui.OutlinedNumberInput
...
import me.devnull.renegadeincai.search.SearchResult
...
private fun SearchServiceOptionsEditor(
    ...
    when (options) {
        ...
        is SearchServiceOptions.RenegadeHubOptions -> {
            RenegadeHubOptions(options) { onUpdateOptions(it) }
        }
...
@Composable
internal fun RenegadeHubOptions(
    options: SearchServiceOptions.RenegadeHubOptions,
    onUpdateOptions: (SearchServiceOptions.RenegadeHubOptions) -> Unit
) {
    FormItem(
        label = {
            Text(stringResource(R.string.search_detail_api_key))
