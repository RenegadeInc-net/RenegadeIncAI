package me.devnull.renegadeincai.ui.pages.translator
...
import me.devnull.renegadeincai.utils.getText
...
fun TranslatorPage(vm: TranslatorVM = koinViewModel()) {
    ...
    val unknownErrorMessage = stringResource(R.string.update_card_unknown_error)

    // 处理错误
    LaunchedEffect(context) {
        vm.errorFlow.collect { e ->
            toaster.show(e.message ?: unknownErrorMessage, type = ToastType.Error)
        }
    }
