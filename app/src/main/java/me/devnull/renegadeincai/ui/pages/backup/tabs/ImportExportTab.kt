...
import me.devnull.renegadeincai.ui.components.ui.StickyHeader
        ...
        uri?.let { targetUri ->
            scope.launch {
                ...
                runCatching {
                    ...
                    e.printStackTrace()
                    toaster.show(
                        restoreFailedMessage.format(e.message ?: ""),
                    ...
                    onClick = if (!isExporting) {
                        {
                            ...
                            createDocumentLauncher.launch("renegadehub_backup_$timestamp.zip")
                        }
                    } else null,
