...
import me.devnull.renegadeai.data.datastore.DEFAULT_IMAGE_PROVIDERS
import me.devnull.renegadeai.AppScope
import me.devnull.renegadeai.data.ai.mcp.McpServerConfig
import me.devnull.renegadeai.data.ai.prompts.DEFAULT_COMPRESS_PROMPT
import me.devnull.renegadeai.data.ai.prompts.DEFAULT_OCR_PROMPT
import me.devnull.renegadeai.data.ai.prompts.DEFAULT_SUGGESTION_PROMPT
import me.devnull.renegadeai.data.ai.prompts.DEFAULT_TITLE_PROMPT
import me.devnull.renegadeai.data.ai.prompts.DEFAULT_TRANSLATION_PROMPT
import me.devnull.renegadeai.data.ai.prompts.LEARNING_MODE_PROMPT
import me.rerere.asr.ASRProviderSetting
import me.devnull.renegadeai.data.datastore.migration.PreferenceStoreV1Migration
import me.devnull.renegadeai.data.datastore.migration.PreferenceStoreV2Migration
import me.devnull.renegadeai.data.datastore.migration.PreferenceStoreV3Migration
import me.devnull.renegadeai.data.model.Assistant
import me.devnull.renegadeai.data.model.Avatar
import me.devnull.renegadeai.data.model.InjectionPosition
import me.devnull.renegadeai.data.model.Lorebook
import me.devnull.renegadeai.data.model.PromptInjection
import me.devnull.renegadeai.data.model.QuickMessage
import me.devnull.renegadeai.data.model.Tag
import me.devnull.renegadeai.data.sync.s3.S3Config
import me.devnull.renegadeai.ui.theme.CustomTheme
import me.devnull.renegadeai.ui.theme.PresetThemes
import me.devnull.renegadeai.utils.JsonInstant
import me.devnull.renegadeai.utils.toMutableStateFlow
    ...
    val settingsFlowRaw = dataStore.data
        .catch { exception ->
            ...
            Settings(
                ...
                imageProviders = JsonInstant.decodeFromString(preferences[IMAGE_PROVIDERS] ?: "[]"),
        ...
        .map {
            ...
            it.copy(
                providers = providers,
                imageProviders = it.imageProviders.ifEmpty { DEFAULT_IMAGE_PROVIDERS },
        ...
        .map { settings ->
            ...
            settings.copy(
                ...
                // ensure image providers are distinct
                imageProviders = settings.imageProviders.distinctBy { it.id },
...
data class Settings(
    ...
    val imageProviders: List<me.rerere.ai.provider.ImageProviderSetting> = DEFAULT_IMAGE_PROVIDERS,
...
fun Settings.findModelById(uuid: Uuid?, fallback: Uuid? = null): Model? {
    ...
    return uuid?.let {
        this.providers.findModelById(it) ?: this.imageProviders.flatMap { p -> p.models }.find { m -> m.id == it }
    } ?: fallback?.let {
        this.providers.findModelById(it) ?: this.imageProviders.flatMap { p -> p.models }.find { m -> m.id == it }
    }
}
