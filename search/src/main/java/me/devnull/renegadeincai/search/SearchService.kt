    ...
    companion object {
        ...
        fun <T : SearchServiceOptions> getService(options: T): SearchService<T> {
            return when (options) {
                ...
                is SearchServiceOptions.RenegadeHubOptions -> RenegadeHubSearchService
...
sealed class SearchServiceOptions {
    ...
    companion object {
        ...
        val TYPES = mapOf(
            ...
            RenegadeHubOptions::class to "RenegadeHub",
    ...
    @Serializable
    @SerialName("renegadehub")
    data class RenegadeHubOptions(
        override val id: Uuid = Uuid.random(),
        val apiKey: String = "",
        val depth: String = "standard",
    ) : SearchServiceOptions()
