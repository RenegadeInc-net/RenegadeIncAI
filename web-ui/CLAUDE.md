...
| `MessageNode` | `MessageNode` | `app/src/main/java/me/devnull/renegadeincai/data/model/Conversation.kt` |
| `Conversation` | `Conversation` | `app/src/main/java/me/devnull/renegadeincai/data/model/Conversation.kt` |
| `ConversationDto` | `ConversationDto` | `app/src/main/java/me/devnull/renegadeincai/web/dto/WebDto.kt` |
| `Settings` | `Settings` | `app/src/main/java/me/devnull/renegadeincai/data/datastore/PreferencesStore.kt` |
