package me.devnull.renegadeincai.tts.provider.providers
...
import me.devnull.renegadeincai.tts.provider.TTSProvider
    ...
    override fun generateSpeech(
        ...
        val audioData = suspendCancellableCoroutine<ByteArray> { continuation ->
            ...
            val listener = TextToSpeech.OnInitListener { status ->
                ...
                // Create temporary file for audio output using temp directory like RenegadeHubApp
        ...
        emit(
            AudioChunk(
                data = audioData,
                format = me.devnull.renegadeincai.tts.model.AudioFormat.WAV,
                isLast = true,
                metadata = mapOf(
                    "provider" to "system",
